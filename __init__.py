...
class CourseworkSelection(MycroftSkill):
    ...
    @intent_file_handler('coursework1.intent')
    ...
    @intent_file_handler('coursework2.intent')
...
')
    ...
    @intent_file_handler('coursework5.intent')
    def handle_coursework5(self, message):
     ...
     @intent_file_handler('coursework6.intent')
    def handle_coursework6(self, message):
     ...
     @intent_file_handler('coursework7.intent')
    ...
    @intent_file_handler('coursework8.intent')
    ...
    @intent_file_handler('coursework9.intent')
    ...
    @intent_file_handler('coursework10.intent')
    ...
    @intent_file_handler('coursework11.intent')
    ...
    @intent_file_handler('coursework12.intent')
    ...
    @intent_file_handler('coursework13.intent')
    ...
    @intent_file_handler('coursework14.intent')
    ...
    @intent_file_handler('coursework15.intent')
    ...
    @intent_file_handler('coursework16.intent')
    ...
    @intent_file_handler('coursework17.intent')
 ...
 ')    
    ...
    @intent_file_handler('coursework20.intent')
    ...
    @intent_file_handler('coursework21.intent')
    ...
    @intent_file_handler('coursework24.intent')
    ...
    @intent_file_handler('coursework25.intent')
    ...
    @intent_file_handler('coursework26.intent')
    ...
    @intent_file_handler('coursework27.intent')
    ...
    @intent_file_handler('coursework28.intent')
    ...
    @intent_file_handler('coursework29.intent')
